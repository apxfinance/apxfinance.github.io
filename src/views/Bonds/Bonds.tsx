          ...
          <>
            <Route exact path={path}>
                <Container maxWidth="lg">
                    <Typography style={{color:'#fff', fontWeight: 'bold'}} align="left" variant="h5" gutterBottom>
                        Bonds
                    </Typography>
                    <Typography style={{color:'#fff !important', fontSize: '14px'}}>Welcome to the Bonds page. Buy and redeem bonds below.</Typography>
                    <Box mt={2}>
                    <StyledBond>
                    <StyledCardWrapper>
                        <ExchangeCard
